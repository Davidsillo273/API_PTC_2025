...
public class ObservationEntity {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_observations")
    @SequenceGenerator(name = "seq_observations", sequenceName = "seq_observations", allocationSize = 1)
